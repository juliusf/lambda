...
{
    class SchemeBuiltinGreaterThanEqual : SchemeBuiltInFunction
    {
        public override SchemeObject evaluate(ref SchemeAST currentAST, SchemeEvaluator evaluator)
        {
            ...
            Debug.Assert(list[0].GetType() == typeof(SchemeBuiltinGreaterThanEqual));
            ...
            {
                throw new SchemeInvalidArgumentException("Builtin Function GreaterThanEqual expects SchemeInteger or SchemeFloat as parameter. Got something else.");
            }
